...
all_perf %>% ggplot(aes(x = value, fill=group, color=group)) + 
                    ...
                    labs(title = "Density of `audience_score` by `feature_film`", 
                         y = "P(Per Unit Profit)", 
                         x = "Per Unit Profit", 
                         fill = "Model Type",
                         color = "Model Type")
